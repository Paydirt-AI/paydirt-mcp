...
This plugin bundles Paydirt's iOS installation workflow and `paydirt-mcp@2.4.0`.
...
then Claude builds the iOS app and leaves the requested-form setup check visibly open.
